      ...
      <div class="row register_form_main_row">
         <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="register_form_main_box">
               ...
               <div id="keeperFormError" class="error-message">
                  <strong>Please correct the following errors:</strong>
                  <ul id="errorList" style="margin: 10px 0 0 20px;"></ul>
               </div>
               
               <form action="<?php echo base_url()?>keeper-form-submit" method="post" id="keeperForm">
                  <div class="register_form_main_form_box">
                     <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                           <div class="register_form_main_imput_box">
                              <label>Date</label>
                              <input type="date" name="date" placeholder="Enter Your Mobile Number" required>
                           </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                           <div class="register_form_main_imput_box">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const errorContainer = document.getElementById('keeperFormError');
