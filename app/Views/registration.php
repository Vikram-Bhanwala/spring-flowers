                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                           <div class="register_form_main_imput_box">
                              <div class="availability_options">
                                 <h4>Type of Work</h4>
                                 <label>
                                 <input type="radio" name="type_of_work" value="live_in_work">
                                 <span class="custom_radio"></span>
                                 Live In
                                 </label>
                                 <label>
                                 <input type="radio" name="type_of_work" value="live_out_work">
                                 <span class="custom_radio"></span>
                                 Live Out
                                 </label>
                                 <label>
                                 <input type="radio" name="type_of_work" value="flexible_work">
                                 <span class="custom_radio"></span>
                                 Flexible
                                 </label>
                              </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                           <div class="register_form_main_imput_box">
                              <div class="availability_options">
                                 <h4>Availability</h4>
                                 <label>
                                 <input type="radio" name="availability_type" value="full_time_availability">
                                 <span class="custom_radio"></span>
                                 Full Time
                                 </label>
                                 <label>
                                 <input type="radio" name="availability_type" value="part_time_availability">
                                 <span class="custom_radio"></span>
                                 Part Time
                                 </label>
                                 <label>
                                 <input type="radio" name="availability_type" value="flexible_availability">
                                 <span class="custom_radio"></span>
                                 Flexible
                                 </label>
                              </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                           <div class="register_form_main_imput_box">
                              <div class="availability_options">
                                 ...
                                 <label>
                                 <input type="radio" name="start_date" value="asap_start">
                                 <span class="custom_radio"></span>
                                 ASAP
                                 </label>
                                 <label>
                                 <input type="radio" name="start_date" value="flexible_start">
                                 <span class="custom_radio"></span>
                                 Flexible
                                 </label>
                              </div>
